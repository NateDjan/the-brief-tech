...
1. **La famille Gemini** — le modèle phare de Google, intégré dans tous ses produits Cloud
2. **Google Workspace with AI** — la suite bureautique enrichie de fonctions IA
3. **Vertex AI** — la plateforme qui permet aux entreprises de déployer et personnaliser leurs propres modèles
4. **Les agents IA** — Google a mis l'accent sur les agents autonomes capables de réaliser des tâches complexes
...
*Pour en savoir plus sur les récents mouvements du secteur tech, consultez notre analyse sur [la guerre des prix entre les modèles IA](/fr/articles/guerre-prix-ia-openai-anthropic-alibaba-2026).*
